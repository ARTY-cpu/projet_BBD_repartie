...
-- Fragment vertical COMMERCIAL : prix et infos fabricant des 10 medicaments
...
-- 6 consultations a Rabat (IDs 7-12)
...
-- Stock de Rabat (IDs 11-20)
-- IdStock 13 est sous le seuil d'alerte
...
-- 7 ventes a Rabat (IDs 10-16)
-- La vente 16 est un patient de Casablanca (IdPatient=1) qui achete a Rabat
...
(16, '2025-04-03', 'Rabat', 1,  22.00);

-- 10 lignes de vente
INSERT INTO LigneVente (IdVente, IdMedicament, Quantite, PrixVente) VALUES
(10, 2,  1, 35.00),
(10, 9,  1, 22.00),   -- Total = 57.00
(11, 5,  1, 55.00),
(12, 8,  1, 65.00),
(12, 6,  1, 28.00),   -- Total = 93.00
(13, 2,  1, 35.00),
(14, 4,  1, 85.00),
(14, 9,  1, 22.00),   -- Total = 107.00
(15, 10, 1, 48.00),
(16, 9,  1, 22.00);   -- achat du patient de Casablanca a Rabat
